...
export function Slide() {
  return (
    <div className="slider fixed top-16 left-0 w-full h-full ">
        ...
        <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
          <div className="px-8">
            ...
            >
              ...
              <h1 className="text-2xl font-bold text-gray-400">Shortcut</h1>
            </div>
            <ul className="mt-12">
              ...
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Friends</span>
                </div>
              </li>
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
