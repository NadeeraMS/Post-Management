...
export function Post() {
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center items-center px-3 w-full md:w-3/3 mt-14">
      <div className="max-w-sm container bg-white rounded-xl shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl">
        ...
        <img
          className="w-387 h-581 cursor-pointer"
          src="https://images.unsplash.com/photo-1589375025852-a66cdd127efb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
          alt=""
        />
